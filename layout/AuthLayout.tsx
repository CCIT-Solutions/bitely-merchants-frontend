...
const AuthLayout = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <div className={`h-screen w-screen flex bg-[#fbfbf9] text-black`}  ref={authRef}   onMouseMove={handleMouseMove}>
      <div className="flex gap-0 w-full h-full max-w-400 mx-auto">
        ...
        <div className="hidden lg:flex lg:w-[60%] relative">
          ...
          <div className="absolute inset-0 flex flex-col w-full p-20 z-10">
            ...
            <div className="flex gap-10 justify-between">
              <Link
                href="/"
                className={"w-40 h-18 relative block cursor-pointer"}
              >
                <Image
                  src={`/logo.png`}
                  alt="Logo"
            ...
            {/* Main Title */}
            <div className="mt-25">
              <span className="block text-5xl font-bold text-primary-foreground">
                {t("auth.title_1")}
              </span>
              ...
              <p className="text-start max-w-xs text-black/50 text-lg font-medium leading-relaxed mt-6">
                {t("auth.subtitle")}
              </p>

              <div className="flex gap-4 mt-10"  style={float3Style}>
                <div className="flex flex-col gap-4 justify-center items-center bg-[#fbfbf9]/30 backdrop-blur-xs border border-primary/50 rounded-lg p-2">
                  <BsLeaf className="text-primary size-12" />
                  <span className="text-black/50 font-medium max-w-20 text-center">
                    {t("auth.feature_1")}
                  </span>
                </div>
                <div className="flex flex-col gap-4 justify-center items-center bg-[#fbfbf9]/30 backdrop-blur-xs border border-primary/50 rounded-lg p-2">
            ...
            <div className="flex gap-3 items-center mt-25 bg-[#fbfbf9]/60 rounded-lg shadow-xs w-fit  p-3 font-medium" style={float1Style}>
              ...
              <div className="flex gap-1">
                <span className="text-md block text-black/50">
                  {t("auth.eatWell")}
                </span>
        ...
        <div className=" w-full sm:w-fit lg:w-163 flex items-center px-4 lg:px-0 lg:rounded-none rounded-4xl mx-auto lg:mx-0">
          <div className="min-w-80 w-full sm:min-w-100 md:w-fit shadow-[0px_0px_10px_10px_#f3f3f394] rounded-3xl text-black bg-white/50 p-10 flex flex-col justify-center items-center gap-5  md:ms-10 mx-auto lg:ms-5">
            <Image
              src="/logo-short.png"
              alt="Short Logo"
              height={60}
