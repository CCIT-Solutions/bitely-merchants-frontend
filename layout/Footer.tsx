...
export default function Footer({
  ...
  return (
    <footer className="w-full bg-neutral-50 dark:bg-primary-foreground pt-10 pb-10 border-t border-border">
      <Animate element="div" variants={fadeDu4}>
        <Container>
          {!minimal && (
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-16 xl:gap-32 py-10">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-4 ">
                  {[FaInstagram, FaXTwitter, FaSnapchat, AiOutlineYoutube].map(
                    (Icon, i) => (
                      <div
                        key={i}
           ...
           <Animate variants={fadeDu1D3} className="
           text-[20vw] 
           xl:text-[300px]  xl:-ms-[5vw]  2xl:-ms-[12vw]  mb-10 lg:mb-14 xl:leading-75
          ...
          {/* Bottom Section */}
          <div className="border-t border-neutral-200 dark:border-primary/10 pt-3 mt-6 flex flex-col lg:flex-row justify-between items-center gap-6 text-neutral-900 dark:text-neutral-100 text-sm">
            <span>
